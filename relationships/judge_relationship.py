...
class JudgeRelationshipHandler:
    ...
    def __init__(self):
        ...
        self.logger.info("📋 Judge Relationship Handler initialized")
    ...
    def create_judge_relationships(self, judgment: JudgmentData) -> List[str]:
        ...
        self.logger.info(f"🔄 Processing {len(judges)} judges for judgment: {judgment.title[:50]}...")
        ...
        for judge_name in judges:
            ...
            self.logger.info(f"✓ Created judge relationship: {judgment.judgment_node} -> {judge_node}")
    ...
    def _get_or_create_judge_node(self, judge_name: str) -> str:
        ...
        self.logger.info(f"📄 Created judge node: {judge_node} for '{judge_name}'")
        return judge_node
    ...
    def reset(self) -> None:
        ...
        self.logger.info("🔄 Judge Relationship Handler reset")
...
def debug_judge_relationships(judgments: List[JudgmentData]) -> None:
    ...
    """
    print("🐛 DEBUG: Testing Judge Relationships")
    print("=" * 50)
    ...
    # Print results
    print(f"\n📊 Results:")
    print(f"   • Total judges created: {stats['total_judges']}")
    print(f"   • Total judge relationships: {stats['judge_relationships']}")
