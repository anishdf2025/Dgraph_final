...
class OutcomeRelationshipHandler:
    ...
    def __init__(self):
        ...
        self.logger.info("⚖️ Outcome Relationship Handler initialized")
    ...
    def create_outcome_relationship(self, judgment: JudgmentData) -> List[str]:
        ...
        if not judgment.outcome or judgment.outcome.lower() in ['nan', '', 'null']:
            self.logger.debug(f"⚠️ No outcome data for judgment: {judgment.title[:50]}...")
        ...
        self.logger.info(f"🔄 Processing outcome '{outcome_clean}' for: {judgment.title[:50]}...")
        ...
        self.logger.info(f"✓ Created outcome relationship: {judgment.judgment_node} -> {outcome_node}")
    ...
    def _get_or_create_outcome_node(self, outcome_name: str) -> str:
        ...
        self.logger.info(f"📄 Created outcome node: {outcome_node} for '{outcome_name}'")
        return outcome_node
    ...
    def reset(self) -> None:
        ...
        self.logger.info("🔄 Outcome Relationship Handler reset")
...
def debug_outcome_relationships(judgments: List[JudgmentData]) -> None:
    ...
    """
    print("🐛 DEBUG: Testing Outcome Relationships")
    print("=" * 50)
    ...
    # Print results
    print(f"\n📊 Results:")
    print(f"   • Total outcomes created: {stats['total_outcomes']}")
    print(f"   • Total outcome relationships: {stats['outcome_relationships']}")
