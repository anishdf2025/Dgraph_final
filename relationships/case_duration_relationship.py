...
class CaseDurationRelationshipHandler:
    ...
    def __init__(self):
        ...
        self.logger.info("📅 Case Duration Relationship Handler initialized")
    ...
    def create_case_duration_relationship(self, judgment: JudgmentData) -> List[str]:
        ...
        if not judgment.case_duration or judgment.case_duration.lower() in ['nan', '', 'null']:
            self.logger.debug(f"⚠️ No case duration data for judgment: {judgment.title[:50]}...")
        ...
        self.logger.info(f"🔄 Processing case duration '{duration_clean}' for: {judgment.title[:50]}...")
        ...
        self.logger.info(f"✓ Created case duration relationship: {judgment.judgment_node} -> {duration_node}")
    ...
    def _get_or_create_case_duration_node(self, duration_info: str) -> str:
        ...
        self.logger.info(f"📄 Created case duration node: {duration_node} for '{duration_info}'")
    ...
    def reset(self) -> None:
        ...
        self.logger.info("🔄 Case Duration Relationship Handler reset")
...
def debug_case_duration_relationships(judgments: List[JudgmentData]) -> None:
    ...
    """
    print("🐛 DEBUG: Testing Case Duration Relationships")
    print("=" * 50)
    ...
    # Print results
    print(f"\n📊 Results:")
    print(f"   • Total case durations created: {stats['total_case_durations']}")
    print(f"   • Total case duration relationships: {stats['case_duration_relationships']}")
